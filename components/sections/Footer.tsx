...
const SOCIAL_LINKS = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/mediabyko/',
    icon: (
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <p className="text-xs text-text-muted">
            © {year} KO Media. All rights reserved.
          </p>
        </div>

        {/* Future route links */}
        <div className="mt-8 pt-6 border-t border-surface-border flex flex-wrap justify-center gap-6 text-xs text-text-muted">
          <Link href="/" className="hover:text-text-secondary transition-colors">Home</Link>
          <Link href="/portfolio" className="hover:text-text-secondary transition-colors">Portfolio</Link>
